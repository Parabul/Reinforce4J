...
public class EuclideanDistanceTest {
  ...
  public void matchesExpectedForRandomState() {
    ...
    Truth.assertThat(distance.between(root, someState)).isWithin(0.001f).of(2.0f);
    Truth.assertThat(distance.between(root, sameState)).isWithin(0.001f).of(2.0f);
    Truth.assertThat(distance.between(someState, root)).isWithin(0.001f).of(2.0f);
  }
}
